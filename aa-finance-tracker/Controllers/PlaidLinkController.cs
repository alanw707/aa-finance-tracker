...
public class PlaidLinkController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(PlaidDataTable), StatusCodes.Status200OK)]
    ...
    public async Task<IActionResult> Transactions()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Name", "Amount/r", "Date/r", "Category", "Channel")
        {
            Rows = added
                .OrderBy(x => x.Date)
                .TakeLast(numresults)
    ...
    public async Task<IActionResult> Identity()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Names", "Emails", "Phone Numbers", "Addresses")
        {
    ...
    public async Task<IActionResult> Investments_Transactions()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Name", "Amount/r", "Date/r", "Ticker")
        {
    ...
    public async Task<IActionResult> Balance()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Name", "AccountId", "Balance/r")
        {
            Rows = response.Accounts
                .Select(x =>
                    new PlaidRow(
    ...
    public async Task<IActionResult> Accounts()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Name", "Balance/r", "Subtype", "Mask")
        {
            Rows = response.Accounts
                .Select(x =>
                    new PlaidRow(
    ...
    public async Task<IActionResult> Item()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Institution Name", "Billed Products", "Available Products")
        {
            Rows =
            [
                new PlaidRow(
    ...
    public async Task<IActionResult> Assets()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Account", "Transactions/r", "Balance/r", "Days Available/r")
        {
    ...
    public async Task<IActionResult> Transfer()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Transfer ID", "Amount/r", "Type", "ACH Class", "Network", "Status")
        {
            Rows = new PlaidRow[]
            {
                new(
    ...
    public async Task<IActionResult> Verification()
    {
        ...
        PlaidDataTable result = new ServerDataTable("Description", "Current Amount/r", "Currency")
        {
            Rows = response.Accounts
                .Select(x =>
                    new PlaidRow(
    ...
    private class ServerDataTable : PlaidDataTable
    {
        internal ServerDataTable(params string[] cols)
        {
            ...
            {
                var split = x.Split("/");
                return new PlaidColumn() { Title = split[0], IsRight = split.Length > 1 && split[1] == "r" };
            }).ToArray();
        }
    }
    ...
    /// </remarks>
    internal class ServerPlaidError : PlaidError
    {
